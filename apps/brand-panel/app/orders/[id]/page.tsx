...
export default function OrderDetailPage() {
  ...
  const handleMarkAsFulfilled = async (trackingData: any) => {
    if (!order?.id) return
    ...
    <PanelLayout>
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        {isFulfillmentModalOpen && (
          <FulfillmentModal
            onConfirm={handleMarkAsFulfilled}
            onCancel={() => setIsFulfillmentModalOpen(false)}
          ...
          <div className="space-y-6">
            ...
            <div className="card">
              ...
              <div className="space-y-3 text-sm">
                ...
                {order.tracking && (
                  <div className="flex gap-3">
                    <div className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full border border-panelWhite bg-transparent font-bold">
                      T
                    </div>
                    <div className="flex-1">
                      <p className="font-medium">Shipped via {order.tracking.carrier?.replace('_', ' ').toUpperCase()}</p>
                      <p className="text-xs text-panelGray">
                      ...
                      {order.tracking.trackingUrl && (
                        <a
                          ...
                          className="mt-1 inline-block text-xs text-panelWhite underline"
                        >
                          Track Shipment
                        </a>
                      )}
